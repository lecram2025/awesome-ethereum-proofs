...
const SOURCE = fs.readFileSync(path.join(__dirname, 'Godlcoin.sol'), 'utf8');
const COMPILER_URL = 'https://binaries.soliditylang.org/bin/soljson-v0.1.7+commit.b4e666cc.js';
const COMPILER_FILE = path.join(__dirname, 'soljson-v0.1.7.js');
...
async function main() {
  console.log('Godlcoin (GOD) Contract Verification');
  console.log('Contract: 0x7a3140be78649bc8a9cf4a116c8bb3023a7d2449');
  ...
  const contract = out.contracts['Godlcoin'];
