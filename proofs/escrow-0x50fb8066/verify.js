...
const SOURCE = fs.readFileSync(path.join(__dirname, 'ShippingEscrow.sol'), 'utf8');
...
async function main() {
  console.log('ShippingEscrow Contract Verification');
  console.log('Contract: 0x50fb8066db65333dcd07087263bdb534a2edbb59');
  ...
  const contract = out.contracts['ShippingEscrow'];
