...
async function main() {
  ...
  console.log('Contract: 0xbdc57bee2fb6d0092ad5437925ad762fec68a548');
  ...
  const txData = await new Promise((resolve, reject) => {
    https.get('https://api.etherscan.io/api?module=proxy&action=eth_getTransactionByHash&txhash=0xdfd9896ccf947e0935ae41713de6b201a8710ef67d85fe22a61f36f06a2703d5', res => {
      let data = '';
