...
| Field | Value |
|-------|-------|
| Address | `0xbdc57bee2fb6d0092ad5437925ad762fec68a548` |
| Deployed | Nov 4, 2015 (block 490,501) |
...
`0x283f1161c2d4ff33fd5d5d4486fc0675732cea11` (block 490,523) has identical runtime bytecode, deployed by the same address 22 blocks later.
