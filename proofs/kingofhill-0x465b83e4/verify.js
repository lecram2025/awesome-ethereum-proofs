...
const SOURCE = fs.readFileSync(path.join(__dirname, 'KingOfHill.sol'), 'utf8');

const EXPECTED_CREATION = '60606040526000805433600160a060020a031991821681178355600180549092161790554260025566038d7ea4c6800060035561025860045561012b90819061004890396000f300' + TARGET_RUNTIME;
...
async function main() {
  console.log('KingOfHill Contract Verification');
  console.log('Contract: 0x465b83e4b4c0294bf6d374d4733b95bb150bd21c');
  ...
  const contract = out.contracts['runtime_bytecode'];
  ...
  const txHash = '0xf56b51dc2454c67c6ff80bf518e5c74ca33191f8fcb28d7ca56247cc9f1cdacf';
