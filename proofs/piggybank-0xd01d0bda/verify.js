...
const SOURCE = fs.readFileSync(path.join(__dirname, 'PiggyBank.sol'), 'utf8');
...
async function main() {
  console.log('PiggyBank Contract Verification');
  console.log('Contract: 0xd01d0bdaa0bdf2358ecfa278fe54eee8952f09fd');
  ...
  const contract = out.contracts['PiggyBank'];
