...
const SOURCE = fs.readFileSync(path.join(__dirname, 'Target.sol'), 'utf8');
...
async function main() {
  console.log('Target Contract Verification');
  console.log('Contract: 0x9e0ae8ffd946d12d1d393c6f3bca0eecadc9428e');
  ...
  const contract = out.contracts['Target'];
